...
<div id="homepost">
 ...
 <div style="height: 4px;"></div>
	  <?php if (have_posts()) : ?>
 	  ...
 	  <?php if( is_tag() ) { ?>
	 <div id="newsmenu">	<div id="newsmenul" style="padding-bottom: 4px;"><?php _e("Tag archive for", "nt"); ?> &#8216;<?php single_tag_title(); ?>&#8217;</div><div class="cb"></div>  </div>


 	  <?php } elseif (is_day()) { ?>
 <div id="newsmenu">	<div id="newsmenul" style="padding-bottom: 4px;"><?php _e("Date archive for", "nt"); ?><?php the_time('F jS, Y'); ?></div><div class="cb"></div>  </div>



 	  <?php } elseif (is_month()) { ?>
 <div id="newsmenu">	<div id="newsmenul" style="padding-bottom: 4px;"><?php _e("Date archive for", "nt"); ?><?php the_time('F, Y'); ?></div><div class="cb"></div>  </div>



 	  <?php } elseif (is_year()) { ?>
	 <div id="newsmenu">	<div id="newsmenul" style="padding-bottom: 4px;"><?php _e("Date archive for", "nt"); ?><?php the_time('Y'); ?></div><div class="cb"></div>  </div>


 	  <?php } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
 <div id="newsmenu">	<div id="newsmenul" style="padding-bottom: 4px;"><?php _e("Blog Archives", "nt"); ?></div><div class="cb"></div> </div> 
